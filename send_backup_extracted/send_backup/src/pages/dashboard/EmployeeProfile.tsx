...
export function EmployeeProfile() {
  ...
  const handleInstallApp = () => {
    if (deferredPrompt) {
      ...
      alert("PWA installation is not ready or already installed. If you are using Opera GX, you can also click the Install icon on the right side of the address bar at the top of the browser.");
    }
  };
